...
Threshold-Sweep QCA (TS-QCA) is a framework for systematically exploring
how different threshold settings affect the results of crisp-set
...
Small changes in these thresholds may lead to substantial differences in
truth tables and minimized solutions.
...
CTS–QCA varies the threshold for **one X condition**, keeping the others
fixed.
...
MCTS–QCA evaluates all combinations of thresholds for multiple X
conditions.
...
DTS–QCA varies both **X thresholds** and **Y thresholds**, creating a
full 2D grid.
...
- A solution sensitive to small threshold changes suggests low
  robustness.
